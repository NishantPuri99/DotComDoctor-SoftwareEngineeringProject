...
df_CC.loc[df_CC['prognosis']!="Dengue","prognosis"] = "Not Dengue"
X_train_CC = df_CC.drop('prognosis',axis=1).copy()
y_train_CC = df_CC['prognosis'].copy()

df_test_CC = pd.read_csv('test_data.csv')
df_test_CC.loc[df_test_CC['prognosis']!="Dengue","prognosis"] = "Not Dengue"
...
pickle.dump(clt_rf_CC,open("Dengue_pred.pkl","wb"))
