...
df_CC.loc[df_CC['prognosis']!="Common Cold","prognosis"] = "Not Common Cold"
X_train_CC = df_CC.drop('prognosis',axis=1).copy()
y_train_CC = df_CC['prognosis'].copy()

df_test_CC = pd.read_csv('test_data.csv')
df_test_CC.loc[df_test_CC['prognosis']!="Common Cold","prognosis"] = "Not Common Cold"
...
pickle.dump(clt_rf_CC,open("CC_pred.pkl","wb"))
